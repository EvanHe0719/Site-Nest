...
test("in-page widget is isolated, interactive, reduced-motion aware and excludes private page data", () => {
  ...
  assert.doesNotMatch(widget, /class="message-avatar"|class="result"/);
  ...
  assert.match(styles, /@keyframes companion-face-blink/);
  assert.match(styles, /radial-gradient\(circle at 38% 24%/);
